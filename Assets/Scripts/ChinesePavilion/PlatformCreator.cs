...
public class PlatformCreator : MonoBehaviour
{
    ...
    public GameObject frencePerfabs;
    ...
    public GameObject CreateFrence(Vector3 scale, bool door)
    {
        GameObject frenceObj = Instantiate(frencePerfabs);
        frenceObj.transform.localScale = scale;
        return frenceObj;
    }
}
